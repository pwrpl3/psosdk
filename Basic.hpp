...
namespace Offsets
{
	constexpr int32 GObjects          = 0x044E4180;
	constexpr int32 AppendString      = 0x00EC1910;
	constexpr int32 GNames            = 0x044A7C40;
	constexpr int32 GWorld            = 0x04629D90;
	constexpr int32 ProcessEvent      = 0x010D8E60;
