...
public:
	...
	uint8                                         Pad_1CE9[0x8];                                     // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMMemoryContainer                  LiteralMemoryStorage;                              // 0x00D0(0x00A0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_1CEA[0x8];                                     // 0x0170(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0178(0x0030)(NativeAccessSpecifierPublic)
	uint8                                         Pad_1CEB[0x8];                                     // 0x01A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1CEC[0x20];                                    // 0x0228(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1CED[0x48];                                    // 0x02A8(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
