...
void ASP_Controller_C::InitializePlayerServer(const class FString& SteamID, const class FString& SteamTicket, const class FString& PlayerSessionId, const struct FSP_PlayerAppearance& SP_PlayerAppearance)
{
	static class UFunction* Func = nullptr;
